        ...
        <div className="container">
          ...
          >
            ...
            <p style={{ fontSize: '0.8rem', color: 'var(--text-espresso-muted)', lineHeight: 1.5 }}>
              <strong>Brand Safety Disclaimer:</strong> Fragrance names are used solely for scent-profile identification. Jassi Perfumes offers custom inspired fragrance profiles and traditional attars, and is not affiliated with the respective original brand owners.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding" style={{ backgroundColor: 'var(--bg-cream)', borderTop: '2px solid var(--accent-gold)' }}>
        <div className="container">
          ...
          <div style={{ textAlign: 'center' }}>
            <a
              href="https://wa.me/919619113993?text=Hi%20Jassi%20Perfumes,%20I%20would%20like%20to%20ask%20about%20your%20concentrated%20Attar%20collection."
              target="_blank"
